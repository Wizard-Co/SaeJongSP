...
using WizMes_SaeJongSP.Properties;
...
#if DEBUG
       private string ConnectionString = "Data Source=wizis.iptime.org,20150;Initial Catalog=MES_SaeJongSP;UID=DBUser;PWD=Wizardis; Connection Timeout=0";
