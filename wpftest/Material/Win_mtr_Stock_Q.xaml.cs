...
namespace WizMes_SaeJongSP
{
    ...
    public partial class Win_mtr_Stock_Q : UserControl
    {
        ...
        WizMes_SaeJongSP.PopUp.NoticeMessage msg = new PopUp.NoticeMessage();
        DataTable DT;
        ...
        private void First_Step()
        {
            ...
            chkAutoInOutIteKJcloud.IsChecked = true;
        ...
        private void FillGrid()
        {
            ...
            sqlParameter.Add("incAutoInOutYN", chkAutoInOutIteKJcloud.IsChecked == true ? "Y" : "N");
        ...
        private void PrintWork(bool previewYN)
        {
            ...
            if ((chkWareHouse.IsChecked == true) && (cboWareHouse.SelectedIndex != -1))     // 창고정보.
            {
                ...
                workrange.Value2 = ((WizMes_SaeJongSP.CodeView)cboWareHouse.SelectedItem).code_name.ToString();
                workrange.HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignLeft;
                workrange.Font.Size = 11;
            }
